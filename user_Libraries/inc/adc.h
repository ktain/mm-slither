...
#define read_LS_Sensor     readADC(ADC1, 15,  ADC_SampleTime_84Cycles)
#define read_RS_Sensor     readADC(ADC1, 14,  ADC_SampleTime_84Cycles)
#define	read_Outz	       	 readADC(ADC1, 4,  ADC_SampleTime_84Cycles)
#define	read_Vref	         readADC(ADC1, 2,  ADC_SampleTime_84Cycles)
